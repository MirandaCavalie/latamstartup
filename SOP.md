...
Pop-ups locales (17/09/2026, actualización más reciente): `countryPreviewOpportunities` selecciona exclusivamente fichas nacionales del país, excluyendo alcance LATAM/global aunque tengan sede nacional. No se rellenan espacios con Rockstart, YLAI u otros programas transfronterizos. El contador del mapa corresponde únicamente a los candidatos locales; «Ver todas» conserva el país y abre el catálogo completo, incluidos fellowships, inversión y recursos regionales/globales. Si no hay fichas locales, el aviso permite abrir ese mismo país en la base, sin cambiar su contexto. No cambia el match ni se eliminan fichas. La suite añade 22 pruebas de regresión (111 en total), incluyendo los 20 países y el caso sin candidatos locales.

Corrección de cobertura y contadores (17/09/2026): las 59 fichas dan cobertura local inicial a los 20 países. Las 14 nuevas entradas viven en `lib/country-opportunities.ts`, con enlaces oficiales y fecha de revisión; logos y procedencia en `public/logos/SOURCES.md`. No se afirma cobertura exhaustiva ni apertura sin confirmación.
...
Verificación de tarjetas flotantes: 41 pruebas automatizadas, TypeScript y compilación de producción. Revisión visual en navegador de escritorio y ancho móvil de 389 px; comprobados detalle con enlace oficial, filtro de Perú al abrir «Ver todas» y retorno al país desde «Volver al mapa». No se añadieron proveedores ni costes de mapas o imágenes.
